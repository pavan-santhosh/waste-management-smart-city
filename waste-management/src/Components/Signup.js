...
function handleClick () {
  ...
  axios.post('http://localhost:8000/api/register/',{
      ...
      "first_name": "first",
      "last_name": "last",
      "username": "pavanrr_santhosh",
      "email": "thera@gmail.com",
      "password": "pavan@123"
  ...
  return (
    <div className='Login_dashboard'>
       ...
       <div className='placement'>
            ...
            <input type='text' className='Input' placeholder='Re-enter password'></input>

            <button className='green_button' onClick={handleClick}>Register</button>
